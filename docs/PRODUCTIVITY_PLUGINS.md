...
Phase 14 provides four isolated marketplace plugins: Gmail, Google Calendar, Notion, and Google Drive. Their manifests use semantic version `1.0.0` and declare only the capability permissions needed for their provider.
